...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
	<head>
		...
		<title>STUDEMY | Beyond Classrooms <?php echo (isset($x->TableTitle) ? $x->TableTitle : ''); ?></title>
		<link id="browser_favicon" rel="shortcut icon" href="<?php echo PREPEND_PATH; ?>resources/images/studemy-icon.png">
		...
		<link rel="stylesheet" href="<?php echo PREPEND_PATH; ?>assets/css/app.css">
