<?php
	...
	// PLEASE NOTE:
	// ============
	// When a new version of studemy is released, new strings
	...
	$Translation['Print Preview'] = 'Print';
	$Translation['Save Changes'] = 'Save Changes';
	$Translation['CSV'] = 'Download';
	...
	// _view.php
	$Translation['tableAccessDenied']="Sorry! You are not Logged In. PLease Log In or Sign Up to join Studemy.";
	...
	// index.php
	$Translation['admin area']="Admin Panel";
	...
	$Translation['db_name help'] = 'The name of the database you want to run your studemy application in.';
