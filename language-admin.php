<?php
	...
	$Translation['studemy forum'] = "studemy Community Forum";
	...
	$Translation['data ownership'] = "Sometimes, you might have tables with data that were entered before implementing this studemy membership management system, or entered using other applications unaware of studemy ownership system. This data currently has no owners. This page allows you to assign owner groups and owner members to this data.";
	...
	$Translation['compare tables page'] = "This page compares the tables and fields structure/schema as designed in studemy to the actual database structure and allows you to fix any deviations.";
	$Translation['field'] = "Field";
	$Translation['studemy definition'] = "studemy definition";
	...
	$Translation['fix field'] = "Fix the field by running an ALTER COLUMN query so that its definition becomes the same as that in studemy.";
	$Translation['fix it'] = "Fix it";
	$Translation['field update warning'] = "DANGER!! In some cases, this might lead to data loss, truncation, or corruption. It might be a better idea sometimes to update the field in studemy to match that in the database. Would you still like to continue?";
	...
	/* Added in studemy 5.73 */
	$Translation['server status disabled'] = 'Server status is disabled on this application. To enable it, regenerate the application with the option "Allow server status in admin area" turned on.';
	$Translation['server status'] = 'Server status';
	$Translation['db status'] = 'Database status';
	$Translation['generated by'] = 'This application was generated by studemy <VERSION> on <DATETIME>.';
	$Translation['column table name'] = 'Table name';
	$Translation['db storage'] = 'Database storage';
	$Translation['column size kb'] = 'Size (KB)';
	$Translation['total'] = 'Total';
	$Translation['php info'] = 'PHP info';
	$Translation['files'] = 'files';
	$Translation['uploads info'] = 'Uploads info';